              ...
              <div className="px-4 py-6 sm:px-8">
                <div className="flex items-center justify-between">
                  ...
                  <p className="text-base font-normal text-gray-900 font-pj">
                    ...
                    <a href="#" title="" className="font-bold rounded hover:underline focus:outline-none focus:ring-1 focus:ring-gray-900 focus:ring-offset-2">
                      Join now
                    </a>
                  </p>
                </div>
                ...
                <svg className="w-auto h-4 mx-auto mb-8 mt-14 text-gray-300" viewBox="0 0 172 16" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
