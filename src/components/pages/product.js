    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="grid grid-cols-1 mt-8 lg:grid-rows-1 gap-y-12 lg:mt-12 lg:grid-cols-5 lg:gap-y-16 lg:gap-x-12 xl:gap-x-16">
                ...
                <div className="lg:flex lg:items-start">
                    <div className="lg:order-2 lg:ml-5">
                        <div className="overflow-hidden border-2 border-transparent rounded-lg">
                            <img className="object-cover w-full h-full" src="https://cdn.rareblocks.xyz/collection/clarity-ecommerce/images/product-details/2/product-1.png" alt="" />
                        </div>
                    </div>
                        ...
                        <div className="flex flex-row items-stretch lg:flex-col lg:space-y-5 space-x-2.5 lg:space-x-0">
                            <button type="button" className="flex-1">
                                <div className="overflow-hidden border-2 border-gray-900 rounded-lg aspect-w-1 aspect-h-1 sm:aspect-w-4 sm:aspect-h-3">
                                    <img className="object-cover w-full h-full" src="https://cdn.rareblocks.xyz/collection/clarity-ecommerce/images/product-details/2/product-2.png" alt="" />
                                </div>
                            </button>

                            <button type="button" className="flex-1">
                                <div className="overflow-hidden border-2 border-transparent rounded-lg aspect-w-1 aspect-h-1 sm:aspect-w-4 sm:aspect-h-3">
                                    <img className="object-cover w-full h-full" src="https://cdn.rareblocks.xyz/collection/clarity-ecommerce/images/product-details/2/product-3.png" alt="" />
                                </div>
                            </button>

                            <button type="button" className="flex-1">
                                <div className="overflow-hidden border-2 border-transparent rounded-lg aspect-w-1 aspect-h-1 sm:aspect-w-4 sm:aspect-h-3">
                                    <img className="object-cover w-full h-full" src="https://cdn.rareblocks.xyz/collection/clarity-ecommerce/images/product-details/2/product-4.png" alt="" />
                                </div>
                            </button>

                            <button type="button" className="flex-1">
                                <div className="overflow-hidden border-2 border-transparent rounded-lg aspect-w-1 aspect-h-1 sm:aspect-w-4 sm:aspect-h-3">
                                    <img className="object-cover w-full h-full" src="https://cdn.rareblocks.xyz/collection/clarity-ecommerce/images/product-details/2/product-5.png" alt="" />
                                </div>
                            </button>
                        </div>
                    </div> */}
            ...
            <div className="lg:col-span-2 lg:row-end-2 lg:row-span-2">
                <h1 className="text-2xl font-bold text-gray-900 sm:text-3xl">Jenny’s Closets - The winter top for female, green</h1>
                ...
                <div className="flex items-center mt-5">
                    ...
                    <p className="ml-2 text-sm font-medium text-gray-400">157 Reviews</p>
                </div>
                ...
                <h2 className="mt-8 text-base font-bold text-gray-900">Features</h2>
                ...
                <h2 className="mt-8 text-base font-bold text-gray-900">Colors</h2>
                <div className="flex items-center mt-5 space-x-3">
                    <label className="-m-0.5 relative p-0.5 rounded-full flex items-center justify-center cursor-pointer focus:outline-none">
                        ...
                        <p className="sr-only">Green</p>
                        <span aria-hidden="true" className="w-8 h-8 rounded bg-emerald-600"></span>
                    </label>

                    <label className="-m-0.5 relative p-0.5 rounded-full flex items-center justify-center cursor-pointer focus:outline-none">
                        <input type="radio" name="color" value="Red" className="sr-only" />
                        <p className="sr-only">Red</p>
                        <span aria-hidden="true" className="w-8 h-8 bg-orange-600 rounded"></span>
                    </label>

                    <label className="-m-0.5 relative p-0.5 rounded-full flex items-center justify-center cursor-pointer focus:outline-none">
                        <input type="radio" name="color" value="Blue" className="sr-only" />
                        <p className="sr-only">Blue</p>
                        <span aria-hidden="true" className="w-8 h-8 bg-indigo-500 rounded"></span>
                    </label>

                    <label className="-m-0.5 relative p-0.5 rounded-full flex items-center justify-center cursor-pointer focus:outline-none">
                        <input type="radio" name="color" value="Gray" className="sr-only" />
                        <p className="sr-only">Gray</p>
                        <span aria-hidden="true" className="w-8 h-8 bg-gray-700 rounded"></span>
                    </label>
                </div>
